...
\hline
\multicolumn{4}{p{0.98\textwidth}}{\footnotesize *Definitions follow the CIE 1976 CIELAB / $L^*C^*_{ab}h_{ab}$ framework, and color differences are measured using the CIEDE2000 ($\Delta E_{00}$) formulation; contrast and harmony are derived metrics defined in Appendix.} \\
\end{tabular}
\end{table}
